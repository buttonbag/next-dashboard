    ...
    <form action={formAction}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <div id="customer-error" arial-live="polite" ariia-atomic="true">
        ...
        <div className="mb-4">
          ...
          <div id="amount-error" arial-live="polite" ariia-atomic="true">
        ...
        <div id="status-error" arial-live="polite" ariia-atomic="true">
